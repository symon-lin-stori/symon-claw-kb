...
- **Name:** Symon Lin
- **Slack mention tag:** `TODO — fill in the real <@ID>`
- **Timezone:** UTC+8
...
- Real Slack mention tag for Symon Lin, to complete the entry above.
- Escalation contact: who receives a task when the retry budget is exhausted?
- Whether the New Home pop-up (Step 3) should be dispatched before or after the New Home
  access whitelist (Step 4) in a real rollout.
